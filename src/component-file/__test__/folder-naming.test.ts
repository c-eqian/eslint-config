...
export const testFolderNaming=()=>{
    ...
    ruleTester.run("folder-naming with options: [{ 'src/pages/**': 'PASCAL_CASE' }]", folderNaming, {
        valid: [
            {
                code: "const name = 'test';",
                filename: 'src/components/Login.vue',
            ...
            },
            {
                ...
                options: [{ 'src/pages/**': 'PASCAL_CASE', 'src/__test__/components/**': 'SNAKE_CASE' }]
            },
            {
                code: "const name = 'test';",
                filename: 'src\\__test__\\components\\login_log\\index-login.vue',
    ...
    ruleTester.run("folder-naming with options: [{ 'ignore': ['pages/src/*'] }]", folderNaming, {
        valid: [
            {
                code: "const name = 'test';",
                filename: 'src/components/table-config/button-config/Login.vue',
                options: [{ 'src/components/**': 'PASCAL_CASE', ignore: ['table-config', 'button-config']  }]
            },
            {
                code: "const name = 'test';",
                filename: 'src/pages/LoginLog.vue',
        ...
        invalid: [
            ...
            },
            {
                code: "const name = 'test';",
                filename: 'src/components/table-config/button-config/Login.vue',
                options: [{ 'src/components/**': 'PASCAL_CASE', ignore: ['table-config']  }],
                errors: [
                    {
